...
<br>
<div id="imgdiv"><img id="divimg" src="photoes/14522909_1237435289656244_3639113885880998867_n.jpg"/></div>

<div class="dropdown">
<button onclick="myFunction()" class="dropbtn">SPECIAL EVENTS IN SCHOOL OF COMPUTING</button>
...
<div id="divbutton">
<a href="#"><button class="button" style="vertical-align:middle" name="year0"><span> Certificate Programme </span></button></a>
<a href="computer_year1.php"><button class="button" style="vertical-align:middle" name="year1"><span> Year One </span></button></a>
<a href="computer_year2.php"><button class="button" style="vertical-align:middle" name="year2"><span> Year Two </span> </button></a>
<a href="computer_year3.php"><button class="button" style="vertical-align:middle" name="year3"><span> Year Three </span></button></a>
<a href="computer_year4.php"><button class="button" style="vertical-align:middle" name="year4"><span> Year Four </span> </button></a>
<a href="computer_pgd.php"><button class="button" style="vertical-align:middle" name="pgd"><span> PGD </span></button></a>
<a href="#"><button class="button" style="vertical-align:middle" name="other"><span> Other </span></button></a>
</div>
