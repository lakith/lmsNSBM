...
<li id="hide7" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp;<a href="files/Switch_Case.pptx"download>Tute-if</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide7','Conditions')">
<img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
