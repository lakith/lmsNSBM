...
$user_access=$user["You have to logged in first!!"];
...
<br>
<div id="filehandling"><div class="filehandlinginside"><h2>1</h2><ul><li id="hide1" class="hidelist"><h3><img src=>&nbsp; <a href="files/Introduction.ppt" download>Introduction</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide1','Introduction')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide1','Introduction')" ><img src="icons/download.png" class="adminshow"></button></h3></li>
<li id="hide2" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp; <a href="files/LANs.ppt" download>LANs</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide2','LANs')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide2','LANs')"><img src="icons/download.png" class="adminshow" id="imghide"></button></h3></li>
</ul></div>

<div class="filehandlinginside"><h2>2</h2><ul><li id="hide3" class="hidelist"><h3>
<img src="icons/vnd-openxmlformats-officedocum.png">&nbsp;
 <a href="files/Network_Models.ppt" download>Network_Models</a>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayblock('hide3','Network_Models')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayhide('hide3','Network_Models')"> <img src="icons/download.png" class="adminshow"></button></h3></li>
<li id="hide4" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp; <a href="files/LAN_connecting_devices_and_virtual_LANs.ppt"download>LAN_connecting_devices_and_virtual_LANs</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide4','LAN_connecting_devices_and_virtual_LANs')"> <img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide4','LAN_connecting_devices_and_virtual_LANs')" ><img class="adminshow" src="icons/download.png">
</button></h3></li>
</ul></div>

<div class="filehandlinginside" id="bottomdivfile"><h2>3</h2><ul><li id="hide5" class="hidelist"><h3>
<img src="icons/vnd-openxmlformats-officedocum.png">&nbsp;
 <a href="files/WLAN.ppt" download>WLAN</a>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayblock('hide5','WLAN')">
 <img src= "icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide5','WLAN')">
 <img src="icons/download.png" class="adminshow" ></button></h3></li>
<li hide="hide6" class="hidelist"><h3><img src="icons/vnd-openxmlformats-officedocum.png">&nbsp; <a href="files/session_09.pptx"download>session_09</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide6','session_09')"> <img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayhide('hide6','session_09')"><img src="icons/download.png" class="adminshow"></button></h3></li>
<li id="hide7" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp;<a href="files/session_10.pptx"download>session_10</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide7','session_10')">
<img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide7','session_10')"><img src="icons/download.png" class="adminshow" ></button>
</h3></li>
</ul></div>
