...
<center><div><h1 id='topic'>SCHOOL OF ENGINEERING</h1></center>
<br>
<div id="imgdiv"><img id="divimg" src="photoes/14517454_1237435342989572_9152697476034172440_n.jpg"/></div>
...
<div id="divbutton">
<a href="Engineering_sub.php"><button class="button" style="vertical-align:middle" name="year1"><span> Year One </span> </button></a>
<a href="Engineering_sub.php"><button class="button" style="vertical-align:middle" name="year2"><span> Year Two </span> </button></a>
<a href="Engineering_sub.php"><button class="button" style="vertical-align:middle" name="year3"><span> Year Three </span> </button></a>
<a href="Engineering_sub.php"><button class="button" style="vertical-align:middle" name="year4"> <span> Year Four </span> </button></a>
<a href="Engineering_sub.php"><button class="button" style="vertical-align:middle" name="pgd"> <span> PGD</span></button></a>
<a href="Engineering_sub.php"><button class="button" style="vertical-align:middle" name="other"><span> Other </span></button></a>
</div>
