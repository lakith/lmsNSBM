...
<br>
<div id="filehandling"><div class="filehandlinginside"><h2>1</h2><ul><li id="hide1" class="hidelist"><h3><img src=>&nbsp; <a href="files/session_01.pptx" download>session_01</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide1','session_01')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide1','session_01')" ><img src="icons/download.png" class="adminshow"></button></h3></li>
<li id="hide2" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp; <a href="files/session_02.pptx" download>session_02</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide2','session_02')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide2','session_02')"><img src="icons/download.png" class="adminshow" id="imghide"></button></h3></li>
</ul></div>

<div class="filehandlinginside"><h2>2</h2><ul><li id="hide3" class="hidelist"><h3>
<img src="icons/vnd-openxmlformats-officedocum.png">&nbsp;
 <a href="files/session_03.pptx" download>session_03</a>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayblock('hide3','session_03')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayhide('hide3','session_03')"> <img src="icons/download.png" class="adminshow"></button></h3></li>
<li id="hide4" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp; <a href="files/session_04.pptx"download>session_04</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide4','session_04')"> <img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide4','session_04')" ><img class="adminshow" src="icons/download.png">
</button></h3></li>
</ul></div>

<div class="filehandlinginside" id="bottomdivfile"><h2>3</h2><ul><li id="hide5" class="hidelist"><h3>
<img src="icons/vnd-openxmlformats-officedocum.png">&nbsp;
 <a href="files/session_05.pptx" download>session_05</a>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayblock('hide5','session_05')">
 <img src= "icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide5','session_05')">
 <img src="icons/download.png" class="adminshow" ></button></h3></li>
<li hide="hide6" class="hidelist"><h3><img src="icons/vnd-openxmlformats-officedocum.png">&nbsp; <a href="files/session_06.pptx"download>session_06</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide6','session_06')"> <img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayhide('hide6','session_06')"><img src="icons/download.png" class="adminshow" onClick="functiondisplayhide('hide6','session_06')"></button></h3></li>
<li id="hide7" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp;<a href="files/session_07.pptx"download>session_07</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide7','session_07')">
<img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide7','session_07')"><img src="icons/download.png" class="adminshow" ></button>
</h3></li>
</ul></div>
