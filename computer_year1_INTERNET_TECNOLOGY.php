...
<?php 
	...
	$sql = mysqli_query($connect,"SELECT avilability FROM yearonecprogramming where id ='$count'");
	$row=mysqli_fetch_array($sql);
	$number[$count]=$row['avilability'];
	}
...
<nav>
	<ul>
        ...
        <div id="hidehide"><h5 id="hideid">You are logged in as <?php echo $log_username ?></h5><form method="post" action="logout.php" id="hideform"><button id="divdisdom" type=  "submit" >Log out</button></form></div>
...
<div id="topic3inside"><center><h3 id="topic3">INTERNET TECHNOLOGY TOPIC OUT LINE</h3></center></div>
<br>
<div id="filehandling"><div class="filehandlinginside"><h2>1</h2><ul><li id="hide1" class="hidelist"><h3><img  src="icons/vnd-openxmlformats-officedocum.png">&nbsp; <a href="files/internet/Lesson_1 (1).pptx" download> Lecturer 01 Introduction</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide1','Lecturer 01 Introduction')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide1','Lecturer 01 Introduction')" ><img src="icons/download.png" class="adminshow"></button></h3></li>
<li id="hide2" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp; <a href="files/internet/Cascading_Stylesheets (1).ppt" download>HTML/CSS Basics</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide2','HTML/CSS Basics')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide2','HTML/CSS Basics')"><img src="icons/download.png" class="adminshow" id="imghide"></button></h3></li>
</ul></div>

<div class="filehandlinginside"><h2>2</h2><ul><li id="hide3" class="hidelist"><h3>
<img src="icons/vnd-openxmlformats-officedocum.png">&nbsp;
 <a href="files/internet/Lesson_3 (1).pptx" download>Lecturer 2 Cascading Style Sheets (CSS)</a>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayblock('hide3','Lecturer 2 Cascading Style Sheets (CSS)')"><img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayhide('hide3','Lecturer 2 Cascading Style Sheets (CSS)"> <img src="icons/download.png" class="adminshow"></button></h3></li>
<li id="hide4" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp; <a href="files/internet/Lesson_5 (1).pptx"download> Floating and Positioning</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide4','Floating and Positioning')"> <img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide4','Floating and Positioning')" ><img class="adminshow" src="icons/download.png">
</button></h3></li>
</ul></div>

<div class="filehandlinginside" id="bottomdivfile"><h2>3</h2><ul><li id="hide5" class="hidelist"><h3>
<img src="icons/vnd-openxmlformats-officedocum.png">&nbsp;
 <a href="files/internet/JavaScript (1).pptx" download> Lecturer 3 Javascript</a>&nbsp;&nbsp;&nbsp;
 <button class="button1" onClick="functiondisplayblock('hide5','Lecturer 3 Javascript')">
 <img src= "icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide5','Lecturer 3 Javascript')">
 <img src="icons/download.png" class="adminshow" ></button></h3></li>
<li hide="hide6" class="hidelist"><h3><img src="icons/vnd-openxmlformats-officedocum.png">&nbsp; <a href="files/internet/Cookies_Sessions (1).ppt"download>PHP Cookies and Sessions</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide6','PHP Cookies and Sessions')"> <img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayhide('hide6','PHP Cookies and Sessions')"><img src="icons/download.png" class="adminshow"></button></h3></li>
<li id="hide7" class="hidelist"><h3><img src="icons/Word_PC.gif">&nbsp;<a href="files/internet/PHP-modified (2).ppt"download>PHP Lecture</a>&nbsp;&nbsp;&nbsp;<button class="button1" onClick="functiondisplayblock('hide7','PHP Lecture')">
<img src="icons/698394-icon-130-cloud-upload-1.png" class="adminshow"></button>&nbsp;&nbsp;&nbsp;
<button class="button1" onClick="functiondisplayhide('hide7','PHP Lecture')"><img src="icons/download.png" class="adminshow" ></button>
</h3></li>
</ul></div>
