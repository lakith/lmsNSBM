...
<center><div><h1 id='topic2'>Year Two</h1></center></div>
<br>

<ul id="course">

    <li><a href="BSFIT.php">BMIS204 Business Statistics for Information Technology</a></li>
    <li><a href="computer_network.php">BMIS210 Computer Networks </a></li>
    <li><a href="#">CS202 Introduction to Cryptography	 </a></li>
    <li><a href="computer_year1_C_Programming.php">BMIS201 Management Practices</a></li>
    <li><a href="#">BMIS203 Data Structures and Algorithms</a></li>
