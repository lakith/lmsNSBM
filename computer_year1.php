...
<ul id="course">
	<li><a href="computer_year1_INTERNET_TECNOLOGY.php">BMIS111 Internet Technology	 </a></li>
    <li><a href="#">Professional Development </a></li>
    <li><a href="computer_year1_C_Programming.php">CS102.3 Programming with C Language</a></li>
    <li><a href="#">ISAD131 Database Management System </a></li>
    <li><a href="#">BMIS101 Introduction to Computer Science</a></li>
